...
// conclusive data model
class ConclusiveDataModel {
  String? id;
  int? networkNo;
  int? dlNo;
  int? seqNo;
  ...
  factory ConclusiveDataModel.fromMap(Map<String, dynamic> json) {
    return ConclusiveDataModel(
      id: json['_id'],
      networkNo: json['networkno'],
      dlNo: json['dlno'],
      seqNo: json['seqno'],
...
class RawDataModel {
  ...
  factory RawDataModel.fromMap(Map<String, dynamic> json) {
    return RawDataModel(
      id: json['_id'],
      networkNo: json['networkno'],
      dlNo: json['dlno'],
